...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Desafio - Gerenciador de Tarefas").description("API de gerenciamento de tarefas")
				.version("1.0.0").license("Repositório GitHub").licenseUrl("https://github.com/jpgfigueired0/desafio-de-projeto-tarefas-casa")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("João Figueiredo", "https://github.com/jpgfigueired0", "contasfigueiredo77@gmail.com");
	}
	...
	private static List<Response> responseMessage() {
		return new ArrayList<Response>() {
...

			{
				...
				add(new ResponseBuilder().code("403").description("Acesso negado!").build());
